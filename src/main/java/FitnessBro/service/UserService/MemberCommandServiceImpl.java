...
public class MemberCommandServiceImpl implements MemberCommandService {
    ...
    public String joinMember(MemberRequestDTO.JoinDTO request) {
        ...
        memberRepository.findByMemberId(request.getMemberId())
                .ifPresent(member -> {
                    throw new AppException(ErrorCode.MEMBERID_DUPLICATED, request.getMemberId() + "는 이미 있습니다.");
                });
    ...
    public String login(String memberId, String password){
        ...
        Member member = selectedMember.orElseThrow(() -> new AppException(ErrorCode.MEMBERID_NOT_FOUND, "해당 멤버를 찾을 수 없습니다."));
